    ...
    const slides = [
        {
            ...
            description: "Unlock the secrets of Calculus, Algebra, and Geometry with expert guidance."
        },
        {
            image: '/ninja-hero.png',
            title: "Your Path to Academic Excellence",
            description: "Join thousands of students who have mastered complex math concepts with ease."
        },
        {
            image: '/dr-islam.jpg',
            title: "Experience the Best Learning",
            description: "Specialized math curriculum designed for high school and university levels."
        }
    ];
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-slate-900/80 to-transparent flex flex-col justify-center items-start px-12 md:px-24 lg:px-40">
                        ...
                        <div className="flex gap-4">
                            <Link href="/signup" className="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/30 hover:-translate-y-1">
                                Start Learning
                            </Link>
                            <Link href="#courses" className="px-8 py-4 bg-white/10 text-white font-bold rounded-xl hover:bg-white/20 transition-all backdrop-blur-md border border-white/20">
                                View Courses
                            </Link>
                        </div>
                    </div>
